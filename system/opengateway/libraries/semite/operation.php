...
class Semite_Operation
{
	...
	{
		$this->addData('countryId', $country_code);
	}
    ...
    {
        $this->addData('merchantAccountType', $merchant_account_type);
    }
	...
	public function processXmlResult (SimpleXMLElement $simplexml)
	{
		...
		{
			$this->_result_authorization_id = $simplexml->TransactionGuid->__toString();
		}
